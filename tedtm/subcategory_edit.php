...
///////////////////////////////////////////////////////////////
  if(isset($_REQUEST['upsubmit'])) {
    ...
    if($resState['flag'] == 'success') {
			...
			echo '<script>location.href="subcategory_edit.php?editid='.$_GET['editid'].'& msg=1";</script>';
    } 
	else {
...
$sqlb="select * FROM sub_category where id='".$_GET['editid']."'";
$pagename="subcategory_edit.php?"; 
...
<h2 class="heading">  Subcategory Edit</h2>
...
<th colspan="2" class="col-md-12"> <ul class="breadcrumb t-breadcrumb-page">
            ...
            <li><a href="dashboard.php">Home</a></li>
			  <li><a href="sub_category.php">Subcategory list</a></li>
          </ul></th>
...
<tbody>
                                                ...
                                                <tr>
												   ...
												   <?php if($getus['category']==$row['name']){ ?> selected <?php } ?>><?php echo $row['name'];?> </option>
												   <?php } ?>
