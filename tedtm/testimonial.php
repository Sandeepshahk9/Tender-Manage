...
$sqlb="select * FROM testmo";
$pagename="testimonial.php?"; 
...
///////////////////////////////////////////////////////////////
  if(isset($_GET['deleteidh'])) {
    ...
    if($resState['flag'] == 'success') {
			...
			echo '<script>location.href="testimonial.php?msg=5";</script>';
    } 
	else {
     echo '<script>location.href="testimonial.php?msg=555";</script>';
    }
}
////////////////////////////////////////////////////////////////
...
<div class="sec-box">
<header>
<h2 class="heading">testimonial List</h2>
</header>
<div class="contents">
...
<input type="hidden" name="tabl" value="testmo"> 
<input type="hidden" name="pgname" value="testimonial.php?">                                
...
?>                                                             
                    ...
                    <tr> <td><input type="checkbox" name="salln[]" id="foo" value="<?php echo $custob['id']; ?>" > </td>
                      ...
                      <td><?php echo substr($custob['descp'], 0, 100) ; ?></td>
					    <td>  <img src="photo/<?php echo $custob['image'] ; ?>" width="50px" height="50px"/> </td>
                     <td>  <img src="images/<?php echo $imgnam; ?>" style="vertical-align:baseline;" width="14" alt="Status" /> </td>
                     
    
                     
                      <td data-value="1">
				 <?php   if($admina['tes_e']=='1') : ?>	  
<a href="testimonial_edit.php?editid=<?php echo $custob['id']; ?>" title="edit"><img src="images/edit.png" alt="Edit"/></a> 
 <?php endif;  if($admina['tes_d']=='1') :?>

<a href="testimonial.php?deleteidh=<?php echo $custob['id']; ?>" title="Delete"><img src="images/cross.png" alt="Del" /></a> 
<?php  endif ; ?>
