...
///////////////////////////////////////////////////////////////
  if(isset($_REQUEST['upsubmit'])) {
    ...
    if($resState['flag'] == 'success') {
			...
			echo '<script>location.href="subscription_edit.php?editid='.$_GET['editid'].'& msg=1";</script>';
    } 
	else {
...
$sqlb="select * FROM sub_plan where id='".$_GET['editid']."'";
...
<h2 class="heading">Subscription Plan Edit</h2>
											...
											><?php echo $row['statename'] ;?></option>
                                                ...
                                                <tr>
												   ...
												   <td class="col-md-8"><div class="ui-widget">
                                                     <input type="text"  class="form-control" id="member_email" name="member_email" placeholder ="Please type slow" id="member" value="<?php echo $getus['member_email']; ?>"required></div>
                                                     </td>
                                                </tr>
                                              <tr>
                                                   <td class="col-md-4">Fees</td>
												   <td class="col-md-8">
                                                     <input type="number"  class="form-control" name="fee" value="<?php echo $getus['fee']; ?>" min="0" required>
                                                     </td>
                                                </tr>
											  ...
											  <tr>
												   ...
												   <td class="col-md-8">
                                                     <input type="date" class="form-control" name="plan_start_date" value="<?php echo $getus['plan_start_date']; ?>" required>
                                                     </td>
                                                </tr>	
											  ...
											  <tr>
												  ...
												  <?php $duration=$getus['duration'];
												     echo   $month=$duration%12;
													echo	$year=$duration/12;
												  for($i=1;$i<=5;$i++){?>
					           <option value="<?php echo $i*12 ;?>" <?php if($i==intval($year)) { ?>selected <?php } ?>><?php echo $i ;?></option>
												  <?php  }  ?>
												   </select>
																 </td>
												  ...
												  <?php for($i=1;$i<=12;$i++){?>
											<option value="<?php echo $i ;?>"<?php if($i==intval($month)) {  ?>selected <?php } ?>><?php echo $i ;?></option>
												  <?php  }  ?>
												   </select>
																   </td>
                                              ...
                                              <tr>
												   ...
												   <td class="col-md-8">
                                                     <textarea id="editor1" rows="5" col="80" name="descp"><?php  echo $getus['descp'] ;?></textarea>
                                                     </td>
                                                </tr>
