...
///////////////////////////////////////////////////////////////
  ...
  if(isset($_REQUEST['submit'])) {
    ...
    if($resState['flag'] == 'success') {
			...
			echo '<script>location.href="faq.php?msg=6";</script>';
    } 
	else {
...
<h2 class="heading">faq Details</h2>
...
<tbody>
                                                ...
                                                <tr>
												   ...
												   <td class="col-md-8">
                                                     <input type="text" placeholder="Question" class="form-control" name="name" required>
                                                     </td>
                                                </tr>
                                            ...
                                            <tr>   
									         <td class="col-md-4">Answer</td>
                                                   <td class="col-md-8">
                                                     <textarea id="editor1" rows="5" col="80" name="descp" required></textarea>
                                                     </td>
                                                </tr>
