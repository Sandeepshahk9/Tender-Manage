...
<div class="sec-box">
<header>
<h2 class="heading">Subscription  List</h2>
</header>
<div class="contents">
...
?>                                                             
                    ...
                    <tr> <td><input type="checkbox" name="salln[]" id="foo" value="<?php echo $custob['id']; ?>" >   </td>
                      ...
                      <td><?php echo $custob['sub_category']; ?></td>
					    <td><?php  $state = explode(",",$custob['state'])  ;$result='';
						 foreach($state as $key){
                            $str=mysql_query("select * from state where id='".$key."'");
							$str=mysql_fetch_array($str);
							$result=$result.'  '.$str['statename'].'  /  ';
                          }
						 echo   $result;
						 ?></td>
				        <td><?php echo $custob['fee'] .' '.'₹' ; ?></td>
                       <td><?php echo $custob['duration'].' '.'months'; ?></td>
					   <td><?php echo date('d-m-Y',strtotime($custob['plan_start_date'])); ?></td>
                     <td><img src="images/<?php echo $imgnam; ?>" style="vertical-align:baseline;" width="14" alt="Status" /> </td>
    
                     
                      <td data-value="1">
					  <?php   if($admina['sub_pla_e']=='1') : ?>
<a href="subscription_edit.php?editid=<?php echo $custob['id']; ?>" title="edit"><img src="images/edit.png" alt="Edit"/></a>
<?php endif;  if($admina['sub_pla_d']=='1') :?>
 
<a href="subscription.php?deleteidh=<?php echo $custob['id']; ?>" title="Delete"><img src="images/cross.png" alt="Del" /></a>
<?php  endif ; ?>
