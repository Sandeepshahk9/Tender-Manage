...
$sqlb="select * FROM sub_category ";
$pagename="sub_category.php?"; 
...
///////////////////////////////////////////////////////////////
  if(isset($_GET['deleteidh'])) {
    ...
    if($resState['flag'] == 'success') {
			...
			echo '<script>location.href="sub_category.php?msg=5";</script>';
    } 
	else {
     echo '<script>location.href="sub_category.php?msg=555";</script>';
    }
}
////////////////////////////////////////////////////////////////
...
<div class="sec-box">
<header>
<h2 class="heading">Subcategory List</h2>
</header>
<div class="contents">
...
<input type="hidden" name="tabl" value="sub_category"> 
<input type="hidden" name="pgname" value="sub_category.php?">                                
...
if($numub>0)
	...
	$sqlgb = $sqlb." ORDER BY category ASC LIMIT ".$pagestart.",".$pageentry;
...
?>                                                             
                    ...
                    <tr> <td><input type="checkbox" name="salln[]" id="foo" value="<?php echo $custob['id']; ?>" > </td>
                     ...
                     <td>  <img src="images/<?php echo $imgnam; ?>" style="vertical-align:baseline;" width="14" alt="Status" /> </td>
                      ...
                      <td data-value="1">
					  					   <?php   if($admina['sub_cat_e']=='1') : ?>
<a href="subcategory_edit.php?editid=<?php echo $custob['id']; ?>" title="edit"><img src="images/edit.png" alt="Edit"/></a> 
 <?php endif;  if($admina['sub_cat_d']=='1') :?>

<a href="sub_category.php?deleteidh=<?php echo $custob['id']; ?>" title="Delete"><img src="images/cross.png" alt="Del" /></a>
<?php  endif ; ?>
