...
///////////////////////////////////////////////////////////////
  if(isset($_GET['deleteidh'])) {
    ...
    if($resState['flag'] == 'success') {
			...
			echo '<script>location.href="faq.php?msg=5";</script>';
    } 
	else {
     echo '<script>location.href="faq.php?msg=555";</script>';
    }
}
////////////////////////////////////////////////////////////////
...
<input type="hidden" name="tabl" value="faq"> 
<input type="hidden" name="pgname" value="faq.php?">                                
...
?>                                                             
                    ...
                    <tr> <td><input type="checkbox" name="salln[]" id="foo" value="<?php echo $custob['id']; ?>" > </td>
                     ...
                     <td>  <img src="images/<?php echo $imgnam; ?>" style="vertical-align:baseline;" width="14" alt="Status" /> </td>
                      ...
                      <td data-value="1">
 <?php   if($admina['faq_e']=='1') : ?>
<a href="faq_edit.php?editid=<?php echo $custob['id']; ?>" title="edit"><img src="images/edit.png" alt="Edit"/></a> 
<?php endif;  if($admina['faq_d']=='1') :?>

<a href="faq.php?deleteidh=<?php echo $custob['id']; ?>" title="Delete"><img src="images/cross.png" alt="Del" /></a>
<?php  endif ; ?>
