...
<input type="hidden" name="pgname" value="company.php?">                                
...
<a href="company.php?deleteidh=<?php echo $custob['id']; ?>" title="Delete"><img src="images/cross.png" alt="Del" /></a>  
<?php  endif ; ?>
