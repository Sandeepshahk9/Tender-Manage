...
///////////////////////////////////////////////////////////////
  if(isset($_REQUEST['upsubmit'])) {
    ...
    if($resState['flag'] == 'success') {
			...
			echo '<script>location.href="state_edit.php?editid='.$_GET['editid'].'& msg=1";</script>';
    } 
	else {
...
$sqlb="select * FROM state where id='".$_GET['editid']."'";
$pagename="state_edit.php?"; 
...
<h2 class="heading">  state Edit</h2>
...
<tbody>
                                               ...
                                               <tr>
												   ...
												   <td class="col-md-8">
                                                     <input type="text" class="form-control" name="statename" value="<?php echo $getus['statename']; ?>"required>
                                                     </td>
                                                </tr>
