...
$sqlb="select * FROM member where name like '".$_POST['search']."%' OR email like '".$_POST['search']."%' ";
...
<?php   if($admina['mem_e']=='1') : ?>
<a href="member_edit.php?editid=<?php echo $custob['id']; ?>" title="edit"><img src="images/edit.png" alt="Edit"/></a> 
 <?php endif;  if($admina['mem_d']=='1') :?>
<a href="members.php?deleteidh=<?php echo $custob['id']; ?>" title="Delete"><img src="images/cross.png" alt="Del" /></a> 
<?php  endif ; ?>
</td>
                    </tr>
