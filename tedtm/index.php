...
<a href="#"><img src="../admin/photo/<?php echo $headr['logo']; ?>" class="img-responsive"></a>
...
<br>
  ...
  <div class="form-group">
    ...
    <label for="inputEmail3" style="margin-top:0;" class="col-sm-2 control-label">Username</label>
