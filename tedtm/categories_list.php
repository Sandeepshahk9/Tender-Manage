...
$sqlb="select * FROM category";
$pagename="categories_list.php?"; 
...
///////////////////////////////////////////////////////////////
  if(isset($_GET['deleteidh'])) {
	 ...
	 $check=mysql_query("select id from sub_category where category='".$_GET['name']."'");
	 $check_row=mysql_num_rows($check);
	 if($check_row>0){
		 
	     echo '<script>location.href="categories_list.php?msg=8";</script>';
	  } else {
    ...
    if($resState['flag'] == 'success') {
			...
			echo '<script>location.href="categories_list.php?msg=5";</script>';
    } 
	else {
     echo '<script>location.href="categories_list.php?msg=555";</script>';
    }
 }
}
////////////////////////////////////////////////////////////////
...
echo "<div class='alert alert-danger'>Please First Delete Sub Category Of this category</div>";}
...
<input type="hidden" name="tabl" value="category"> 
<input type="hidden" name="pgname" value="categories_list.php?">                                
...
?>                                                             
                    ...
                    <tr> 
				<!--	<td><input type="checkbox" name="salln[]" id="foo" value="<?php echo $custob['id']; ?>" >   </td>  -->
                      <td><?php echo $cont; ?></td>
                     ...
                     <td> <img src="images/<?php echo $imgnam; ?>" style="vertical-align:baseline;" width="14" alt="Status" /> </td>
					  ...
					  <?php   if($admina['cat_e']=='1') : ?>
					  
<a href="category_edit.php?editid=<?php echo $custob['id']; ?>" title="edit"><img src="images/edit.png" alt="Edit"/></a> 
       <?php endif;  if($admina['cat_d']=='1') :?>
	   
<a href="categories_list.php?deleteidh=<?php echo $custob['id'].'&name='.$custob['name']; ?>" title="Delete"><img src="images/cross.png" alt="Del" /></a> 
<?php  endif ; ?>
