...
///////////////////////////////////////////////////////////////
  if(isset($_GET['deleteidh'])) {
    ...
    if($resState['flag'] == 'success') {
			...
			echo '<script>location.href="enq.php?msg=5";</script>';
    } 
	else {
     echo '<script>location.href="enq.php?msg=555";</script>';
    }
}
...
<div class="sec-box">
<header>
<h2 class="heading">Enquiries List</h2>
</header>
<div class="contents">
...
echo "<div class='alert alert-success'>reply Send Successfully</div>";}
...
<!--  <a href="seo_add.php">
 ...
 <tr>
				...
				<div style="float:right; padding-right:20px;"><strong>Total - <?php echo $numub; ?></strong></div>
...
<input type="hidden" name="tabl" value="enquiry"> 
<input type="hidden" name="pgname" value="enq.php?">                                
...
?>                                                             
                    ...
                    <tr> <td><input type="checkbox" name="salln[]" id="foo" value="<?php echo $custob['id']; ?>" > </td>
                      ...
                      <td><?php echo substr($custob['email'], 0, 100) ; ?></td>
					    <td><?php echo $custob['number'] ; ?></td>
					   <td><?php echo $custob['msg'] ; ?></td>
	 ...
	 <?php   if($admina['enq_d']=='1') : ?>
	<a href="enq.php?deleteidh=<?php echo $custob['id']; ?>" title="Delete"><img src="images/cross.png" alt="Del" /></a> 
    <?php  endif ; ?>
	</td>
...
<?php   if($admina['enq_e']=='1') : ?>
<button type="submit" class="btn btn-warning" name="reply" data-toggle="modal" data-target="#reply-all">Reply </button> 
 <?php endif;  if($admina['enq_d']=='1') :?>
...
<!------modal-reply--------
<div id="reply" class="modal fade in reply-sec" role="dialog" >
		  <div class="modal-dialog">
			<div class="modal-content">
			  ...
			  <div class="modal-body changepassword-sec-modal" style="    background: linear-gradient(180deg, #4c6675, #cccccc);">
					<form action="action.php" method="post">
											
						<div class="row form-group">
							
							<div class="col-md-12">
								 <textarea class="form-control" id="editor1" rows="10"  name="msg" required>   </textarea>
								</div>			
						</div>			
...
<div  id="reply-all" class="reply-sec modal fade in " role="dialog" >
		  <div class="modal-dialog">
			<div class="modal-content">
			  <div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">×</button>
				<h4 class="modal-title text-center">Reply Selected</h4>
			  </div>
			  <div class="modal-body changepassword-sec-modal" style="background: linear-gradient(180deg, #4c6675, #cccccc);">
						...
						<div class="form-group">
							<button type="submit" name="reply" class="btn btn-default">send</button>						
						</div>
					</form>
			  </div>
