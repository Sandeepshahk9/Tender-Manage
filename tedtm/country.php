...
$sqlb="select * FROM country";
$pagename="country.php?"; 
...
///////////////////////////////////////////////////////////////
  if(isset($_GET['deleteidh'])) {
    ...
    if($resState['flag'] == 'success') {
			...
			echo '<script>location.href="country.php?msg=5";</script>';
    } 
	else {
     echo '<script>location.href="country.php?msg=555";</script>';
    }
}
////////////////////////////////////////////////////////////////
...
<div class="sec-box">
<header>
<h2 class="heading">country List</h2>
</header>
<div class="contents">
...
<li><?php if($admina['loc_cou_a']=='1') { ?>
  <a href="country_add.php">
...
<input type="hidden" name="tabl" value="country"> 
<input type="hidden" name="pgname" value="country.php?">                                
...
?>                                                             
                    ...
                    <tr> <td><input type="checkbox" name="salln[]" id="foo" value="<?php echo $custob['id']; ?>" > </td>
                     ...
                     <td>  <img src="images/<?php echo $imgnam; ?>" style="vertical-align:baseline;" width="14" alt="Status" /> </td>
                      ...
                      <td data-value="1">
					   <?php   if($admina['loc_cou_e']=='1') : ?>
<a href="country_edit.php?editid=<?php echo $custob['id']; ?>" title="edit"><img src="images/edit.png" alt="Edit"/></a> 
 <?php endif;  if($admina['loc_cou_d']=='1') :?>

<a href="country.php?deleteidh=<?php echo $custob['id']; ?>" title="Delete"><img src="images/cross.png" alt="Del" /></a> 
<?php  endif ; ?>
</td>
                    </tr>
