...
$sqlb="select * FROM tender where tittle like '".$_GET['titl']."%'";
$pagename="tender_sr.php?titl".$_GET['titl']."&"; 
...
<li><?php if($admina['ten_a']=='1') { ?>
  <a href="tender_add.php">
 ...
 <tr>
                         ...
                         <form role="form" class="form-inline" method="GET" action="tender_sr.php">                             
                      <div class="search-box">
                    <input type="text" placeholder="tittle" name="titl" />
...
<input type="hidden" name="pgname" value="tender_sr.php?">                                
...
?>                                                             
                    ...
                    <tr> <td><input type="checkbox" name="salln[]" id="foo" value="<?php echo $custob['id']; ?>" >   </td>
                     ...
                     <td><img src="images/<?php echo $imgnam; ?>" style="vertical-align:baseline;" width="14" alt="Status" /> </td>
                      ...
                      <td data-value="1">
					  <?php   if($admina['ten_e']=='1') : ?>
<a href="tender_edit.php?editid=<?php echo $custob['id'];  ?>" title="edit"><img src="images/edit.png" alt="Edit"/></a> 

 <?php endif;  if($admina['ten_d']=='1') :?>
<a href="tender_sr.php?titl=<?php echo $_GET['titl'] ; ?>&deleteidh=<?php echo $custob['id']; ?>" 
title="Delete"><img src="images/cross.png" alt="Del"/></a>
<?php  endif ; ?>
