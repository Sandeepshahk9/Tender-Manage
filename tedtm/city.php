...
///////////////////////////////////////////////////////////////
  if(isset($_GET['deleteidh'])) {
    ...
    if($resState['flag'] == 'success') {
			...
			echo '<script>location.href="city.php?msg=5";</script>';
    } 
	else {
     echo '<script>location.href="city.php?msg=555";</script>';
    }
}
////////////////////////////////////////////////////////////////
...
<input type="hidden" name="tabl" value="city"> 
<input type="hidden" name="pgname" value="city.php?">                                
...
if($numub>0)
	...
	$sqlgb = $sqlb." ORDER BY stateid DESC LIMIT ".$pagestart.",".$pageentry;
...
?>                                                             
                    ...
                    <tr> <td><input type="checkbox" name="salln[]" id="foo" value="<?php echo $custob['id']; ?>" > </td>
                      <td><?php echo $cont; ?></td>
					   ...
					   <td><?php echo $custob['city']; ?></td>
					   
                     <td><?php $row=san_select('state','id',$custob['stateid']) ;
					  $row=mysql_fetch_array($row); echo $row['statename'];?></td>
					  
                      <td><?php $row=san_select('country','id',$custob['countryid']) ;
					  $row=mysql_fetch_array($row); echo $row['country'];?></td>
	  ...
	  <?php   if($admina['loc_cit_e']=='1') : ?>
<a href="city_edit.php?editid=<?php echo $custob['id']; ?>" title="edit"><img src="images/edit.png" alt="Edit"/></a> 

       <?php endif;  if($admina['loc_cit_d']=='1') :?>
<a href="city.php?deleteidh=<?php echo $custob['id']; ?>" title="Delete"><img src="images/cross.png" alt="Del" /></a> 
      <?php  endif ; ?>
