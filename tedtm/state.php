...
///////////////////////////////////////////////////////////////
  if(isset($_GET['deleteidh'])) {
    ...
    if($resState['flag'] == 'success') {
			...
			echo '<script>location.href="state.php?msg=5";</script>';
    } 
	else {
     echo '<script>location.href="state.php?msg=555";</script>';
    }
}
////////////////////////////////////////////////////////////////
...
<div class="sec-box">
<header>
<h2 class="heading">state List</h2>
</header>
<div class="contents">
...
<li><?php if($admina['loc_sta_a']=='1') { ?>
  <a href="state_add.php">
...
<input type="hidden" name="tabl" value="state"> 
<input type="hidden" name="pgname" value="state.php?">                                
...
if($numub>0)
	...
	$sqlgb = $sqlb." ORDER BY statename ASC LIMIT ".$pagestart.",".$pageentry;
...
?>                                                             
                    ...
                    <tr> <td><input type="checkbox" name="salln[]" id="foo" value="<?php echo $custob['id']; ?>" > </td>
                      <td><?php echo $cont; ?></td>
                      <td><?php echo $custob['statename']; ?></td>
                     ...
                     <td>  <img src="images/<?php echo $imgnam; ?>" style="vertical-align:baseline;" width="14" alt="Status" /> </td>
                      ...
                      <td data-value="1">
					   <?php   if($admina['loc_sta_e']=='1') : ?>
<a href="state_edit.php?editid=<?php echo $custob['id']; ?>" title="edit"><img src="images/edit.png" alt="Edit"/></a> 
 <?php endif;  if($admina['loc_sta_d']=='1') :?>

<a href="state.php?deleteidh=<?php echo $custob['id']; ?>" title="Delete"><img src="images/cross.png" alt="Del" /></a> 
<?php  endif ; ?>
