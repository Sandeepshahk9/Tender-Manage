...
<input type="hidden" name="pgname" value="tender.php?">                                
...
<a href="tender.php?deleteidh=<?php echo $custob['id']; ?>" title="Delete"><img src="images/cross.png" alt="Del" /></a> 
<?php  endif ; ?>
