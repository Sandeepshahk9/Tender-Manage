...
///////////////////////////////////////////////////////////////
  if(isset($_GET['deleteidh'])) {
    ...
    if($resState['flag'] == 'success') {
			...
			echo '<script>location.href="sub_email.php?msg=5";</script>';
    } 
	else {
     echo '<script>location.href="sub_email.php?msg=555";</script>';
    }
}
////////////////////////////////////////////////////////////////
...
<div class="sec-box">
<header>
<h2 class="heading"> Subscribed Email List</h2>
</header>
<div class="contents">
...
<li class="active"> Subscribed Email List</li>
<li>
...
<input type="hidden" name="pgname" value="sub_email.php?">                                
...
?>                                                             
                    ...
                    <tr> <td><input type="checkbox" name="salln[]" id="foo" value="<?php echo $custob['id']; ?>" > </td>
                     ...
                     <td>  <img src="images/<?php echo $imgnam; ?>" style="vertical-align:baseline;" width="14" alt="Status" /> </td>
                      ...
                      <td data-value="1">
  <?php  if($admina['sub_ema_d']=='1') :?>
<a href="sub_email.php?deleteidh=<?php echo $custob['id']; ?>" title="Delete"><img src="images/cross.png" alt="Del" /></a>
<?php  endif ; ?>
