				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="Tender_Listing_sec-2">
					           ...
					           <?php  
								  ...
								  if(isset($_REQUEST['header_search'])){
								     $qw=$_REQUEST['qw'];
								   ...
								   AND tittle like  '%$qw%' ";
                                    ...
                                    $numub=mysql_num_rows($tabletb);
									  $pagename="Tender_search.php?header_search&qw=".$_REQUEST['qw']."&";
								 ...
								 $pagename="Tender_search.php?";
								 
								 if($cat!=''){
                                          $sqlb=$sqlb."AND category='".$cat."'";
										  $pagename=$pagename."category=".$cat."&";
                                      }
								if($sub_cat!=''){
                                          $sqlb=$sqlb."AND sub_category='".$sub_cat."'";
										  $pagename=$pagename."sub_cat=".$sub_cat."&";
                                      }	  
									  
								 if($con!=''){
                                          $sqlb=$sqlb."AND country='".$con."'";
										  $pagename=$pagename."country=".$con."&";
                                      }
								  if($state!=''){
                                          $sqlb=$sqlb."AND state='".$state."'";
										  $pagename=$pagename."state=".$state."&";
                                      }
								if($city!=''){
                                          $sqlb=$sqlb."AND city='".$city."'";
										   $pagename=$pagename."city=".$city."&";
                                      }
