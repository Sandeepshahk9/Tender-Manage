				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
								<div class="search-tender-category-location">
									<h2><i class="fa fa-bars" aria-hidden="true"></i> Tender By Category</h2>
									<ul>
									<?php  $state=mysql_query("select * from sub_category where status='1' AND category='".$_REQUEST['category']."' ORDER by name ASC ") ;
                                       	while($st=mysql_fetch_array($state)){		?>
									
								<li><a href="Tender_search.php?sub_cat=<?php echo $st['name']; ?>"><span><i class="fa fa-map-marker" aria-hidden="true"></i></span> Tender in <?php echo $st['name']; ?></a></li>
