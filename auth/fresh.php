...
///////////////////////////////////////////////////////////status check code
 ...
 ///////////////////////////////////////////////////////package check code
		         ...
		         if($packag_check < $todate){ echo "<li>Your Subscription Plan Ended. Please Renew!</li>" ;
				  ...
				  $end=date ("Y-m-d", strtotime("-10 day", strtotime($start)));
				  ...
				  while (strtotime($end) <= strtotime($start)) {
					     ...
					     $stat=explode(",",$plan['state']) ; foreach($stat as $san) { 
								 ...
								 ///////////////////li code///////////////////////////////////////////// 
								  ...
								  $str="select id from tender where added_date='".$end."' AND sub_category='".$key."' AND state='".$san."' ";
             ...
             $pagename="fresh.php?"; 
				...
				$szlb="select * from tender where (added_date='".$fresh_date."') AND ";			
					       $sub='';				
