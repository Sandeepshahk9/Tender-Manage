...
$sqlb="select * FROM subscription";
$pagename="promotion.php?"; 
...
<div class="sec-box">
<header>
<h2 class="heading">  Email List</h2>
</header>
<div class="contents">
...
<li>
				  ...
				  <form role="form" class="form-inline" method="post" action="">      
                    ...
                    <input type="submit" value="Perpage" />
					 ...
					 -------------> 
					<td><a href="promotion-add.php"><button type="button" class="btn btn-primary btn-sm">Enter Manually</button></a></td><td></td><td></td><td></td><td></td>
				<td><div style="float:right; padding-right:10px;"><strong>Total - <?php echo $numub; ?></strong></div></td>
                     ...
                     <form name="" action="promotion-tender-list.php" method="post">
<input type="hidden" name="colname" value="salln"> 
<input type="hidden" name="tabl" value="subscription"> 
<input type="hidden" name="pgname" value="promotion.php?">                                
...
?>                                                             
                    ...
                    <tr> <td><input type="checkbox" name="salln[]" id="foo" value="<?php echo $custob['email']; ?>" > </td>
                      <td><?php echo $cont; ?></td>
...
<button type="submit" class="btn btn-success" name="sendallemail">Continue</button> 
