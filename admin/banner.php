...
///////////////////////////////////////////////////////////////
  if(isset($_GET['deleteidh'])) {
    ...
    if($resState['flag'] == 'success') {
			...
			echo '<script>location.href="banner.php?msg=5";</script>';
    } 
	else {
     echo '<script>location.href="banner.php?msg=555";</script>';
    }
}
////////////////////////////////////////////////////////////////
...
<div class="sec-box">
<header>
<h2 class="heading">Banner List</h2>
</header>
<div class="contents">
...
<input type="hidden" name="tabl" value="banner"> 
<input type="hidden" name="pgname" value="banner.php?">                                
...
?>                                                             
                    ...
                    <tr> <td><input type="checkbox" name="salln[]" id="foo" value="<?php echo $custob['id']; ?>" > </td>
                      ...
                      <td><?php echo $custob['position']; ?></td>
                     ...
                     <td>  <img src="images/<?php echo $imgnam; ?>" style="vertical-align:baseline;" width="14" alt="Status" /> </td>
                      ...
                      <td data-value="1">
<a href="banner_edit.php?editid=<?php echo $custob['id']; ?>" title="edit"><img src="images/edit.png" alt="Edit"/></a> 
<a href="banner.php?deleteidh=<?php echo $custob['id']; ?>" title="Delete"><img src="images/cross.png" alt="Del" /></a> </td>
                    </tr>
