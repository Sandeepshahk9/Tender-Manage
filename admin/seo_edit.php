...
///////////////////////////////////////////////////////////////
  ...
  if(isset($_REQUEST['upsubmit'])) {
    ...
    if($resState['flag'] == 'success') {
			...
			echo '<script>location.href="seo_edit.php?editid='.$_GET['editid'].'& msg=1";</script>';
    } 
	else {
...
$sqlb="select * FROM seo where id='".$_GET['editid']."'";
$pagename="seo_edit.php?"; 
...
<tbody>
  <tr>
												   ...
												   <td class="col-md-8">
                                                     <input type="text" placeholder="" class="form-control" name="page" value="<?php echo $getus['page']; ?>" required>
                                                     </td>
                                                </tr>
									         ...
									         <td class="col-md-4">Meta Keyword</td>
                                                   <td class="col-md-8">
                                                     <textarea id="editor2" rows="5" col="80" name="keyword"><?php echo $getus['keyword']; ?></textarea>
                                                     </td>
                                                </tr>
