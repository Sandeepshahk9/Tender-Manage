  ...
  if(isset($_REQUEST['submit'])) {
   ...
   $extension  = array('jpg', 'jpeg', 'png', 'bmp');
    ...
    if($resState['flag'] == 'success') {
			...
			echo '<script>location.href="testimonial.php?msg=6";</script>';
    } 
	else {
...
<h2 class="heading">testimonial Details</h2>
...
<tbody>
									         ...
									         <td class="col-md-4">Descp</td>
                                                   <td class="col-md-8">
                                                     <textarea id="editor1" class="form-control" rows="5" col="200" name="descp" required></textarea>
                                                     </td>
                                                </tr>
