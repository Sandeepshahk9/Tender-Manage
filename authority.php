...
<head>
   ...
   <?php include_once('headerlink.php'); ?>
	<title>tendertm/Authority</title>
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="search-tender-category-location">
									<h2><i class="fa fa-bars" aria-hidden="true"></i> Tender By Authority</h2>
									<ul>
									<?php  $state=mysql_query("select * from company where status='1'  ORDER by name ASC ") ;
                                       	while($st=mysql_fetch_array($state)){		?>
									
								<li><a href="tender_search.php?cn=<?php echo $st['name']; ?>"><span><i class="fa fa-map-marker" aria-hidden="true"></i></span> Tender in <?php echo $st['name']; ?></a></li>
